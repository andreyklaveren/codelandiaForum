            ...
            {cards.map((card, index) => (
                <StyledCard key={index}>
                    <div className="card-header">
                        ...
                        <div>
                            <svg className="icon" onClick={(event) => event.currentTarget.classList.toggle("filled")} width="20" height="20" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
